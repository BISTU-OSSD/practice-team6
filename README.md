...
本项目通过测试驱动开发（TDD）的方式，引导你和队友一步步完成一套功能函数，实现电影管理、数据统计和智能推荐。
...
**建议分工**：
- **2人团队**：成员 A 负责 Issue 1 & 2，成员 B 负责 Issue 3 & 4。
- **3-4人团队**：每人或每两人负责一个 Issue，并行开发。

每个 Issue 都关联了对应的 `Milestone`，方便追踪项目整体进度。

### 2. 开发流程 (基于 main 分支)

由于所有成员都在同一个 `party.py` 文件上开发，为避免代码冲突，请严格遵循以下工作流：
